...
const NAV = [
  ...
  { href: "/candidate/practice",  icon: <BookOpen className="w-4 h-4" />,        label: "Practice" },
  { href: "/candidate/contests",  icon: <Trophy className="w-4 h-4" />,          label: "Contests" },
  { href: "/candidate/results",   icon: <BarChart3 className="w-4 h-4" />,       label: "Results" },
  { href: "/candidate/settings",  icon: <Settings className="w-4 h-4" />,        label: "Settings" },
];
    ...
    <div className="min-h-screen bg-gray-950 flex">
      <aside className="w-60 bg-gray-900 border-r border-gray-800 flex flex-col flex-shrink-0">
        <div className="p-5 border-b border-gray-800">
          <Link href="/candidate/dashboard" className="flex items-center gap-2 text-violet-400 font-bold">
            <BrandLogo size="sm" />
          </Link>
